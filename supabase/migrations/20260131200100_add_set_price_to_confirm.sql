...
COMMENT ON FUNCTION public.confirm_assign_sets_to_users IS 'Executes set assignments, explicitly copying set_ref to envios table and returning set_price';
